---
title: "Predictive Modeling of College Football Bowl Winner with Linear Regression, Random Forests and XGBoost"
author: Igor Aboim 
output:
  md_document:
...
3. Converting the predicted outcome and the test data to a binary win/loss
```{r}
